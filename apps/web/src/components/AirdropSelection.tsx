      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              An existing airdrop was detected. Are you sure you want to create a new airdrop? This action will
              overwrite the current airdrop.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            ...
            <Button onClick={handleConfirmCreate}>Confirm and Create New Airdrop</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </main>
